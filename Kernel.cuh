...
#define ALPHABET_LEN 56

const char ALPHABET[57] = "jabcdefghiklmnopqrstuvwxyzJABCDEFGHIKLMNOPQRSTUVWXYZ,.!@";
__device__ __constant__ char _ALPHABET[57] = "jabcdefghiklmnopqrstuvwxyzJABCDEFGHIKLMNOPQRSTUVWXYZ,.!@";
